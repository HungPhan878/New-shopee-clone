            ...
            <Popover
              renderProps={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  <div>
                    <div className='p-2 text-gray-400 capitalize'>Sản phẩm mới thêm</div>
                    <div className='mt-3'>
                      <div className='p-2 flex hover:bg-slate-100 cursor-pointer'>
                    ...
                    <div className='flex p-2 mt-6 items-center justify-between'>
